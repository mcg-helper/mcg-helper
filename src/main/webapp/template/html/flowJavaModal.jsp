...
<div class="container-fluid" >
	<div class="row">
		<div class="col-md-12">
			<ul class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active"><a href="#${modalId }_javaProperty" data-toggle="tab">属性</a></li>
			  	<li role="presentation"><a href="#${modalId }_coreJava" data-toggle="tab">源代码</a></li>
	...
	<div class="row margin_top">
		<div class="col-md-12">
			<form id="${modalId }_javaForm" class="form-horizontal" role="form">
				<div class="form-body">
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane fade in active" id="${modalId }_javaProperty">
						...
						<div class="tab-pane fade" id="${modalId }_coreJava">
							<div class="form-group">
								<div class="col-sm-12">
						...
						<div class="tab-pane fade" id="${modalId }_explain">
							<div class="form-group">
								<div class="col-sm-12">
									<div class="fg-line">
										业务数据处理控件，流程执行时会自动执行execute方法，其param参数为所有父级控件的运行值，采用fastjson，
										可强转换为JSONObject，JSONArray对象方法操作json，该控件中可执行java语言，将处理后的JSON对象结果返回，
